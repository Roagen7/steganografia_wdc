...
\begin{itemize}
	...
	\item wiadomość - przesyłane dane
	\item kontener (stego-image) - to wszelkie dane służące do ukrycia tajnej wiadomości
...
\section{Algorytmy i przykłady steganografii w obrazach}
